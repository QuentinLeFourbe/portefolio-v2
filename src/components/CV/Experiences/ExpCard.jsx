...
const Container = styled(animated.div)`
  ...
  ${(props) =>
    props.rightSide ? "flex-flow: row-reverse wrap;" : "flex-flow: row wrap;"};
...
const ExpContainer = styled.div`
  ...
  ${(props) =>
    props.rightSide ? "align-items: flex-end;" : "align-items: flex-start;"}
`;
          ...
          <ExpContainer>
            ...
            <animated.div style={{ overflow: "hidden", ...expandSpring }}>
              <InfoContainer ref={measureRef}>
                ...
                <DetailsListItem>
                  {detailsList.map((x, index) => (
                    <DetailListItem key={index}>{x}</DetailListItem>
                  ))}
                </DetailsListItem>
              </InfoContainer>
            </animated.div>
